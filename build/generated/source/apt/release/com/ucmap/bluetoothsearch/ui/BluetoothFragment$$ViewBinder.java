...
public class BluetoothFragment$$ViewBinder<T extends com.ucmap.bluetoothsearch.ui.BluetoothFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492964, "field 'mDeviceName'");
    target.mDeviceName = finder.castView(view, 2131492964, "field 'mDeviceName'");
    view = finder.findRequiredView(source, 2131492979, "field 'mBack' and method 'onClick'");
    target.mBack = finder.castView(view, 2131492979, "field 'mBack'");
    ...
    view = finder.findRequiredView(source, 2131492980, "field 'mDevice' and method 'onClick'");
    target.mDevice = finder.castView(view, 2131492980, "field 'mDevice'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
