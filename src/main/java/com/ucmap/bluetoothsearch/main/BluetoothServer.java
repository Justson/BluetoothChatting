package com.ucmap.bluetoothsearch.main;
...
import com.ucmap.bluetoothsearch.utils.Utils;
...
//                        return;
                    ...
                    if (length != -1) {
                        ...
                        mMessage.obj = new com.ucmap.bluetoothsearch.entity.Message(new String(b, 0, length),
                                MESSAGE_READ,
        ...
        public void write(String message) {
            ...
            try {
                ...
                if (mOs != null && mHandler != null) {
                    ...
                    mMessage.obj = new com.ucmap.bluetoothsearch.entity.Message(message, MESSAGE_WRITE,
